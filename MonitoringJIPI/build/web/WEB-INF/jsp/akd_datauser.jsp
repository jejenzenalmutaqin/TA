...
<html>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="akd_datauser.htm"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Data User</a></li>
...
<!--        begin-content-->
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            <div class="form-group">
                <c:url var="tambahData" value="/tambahUser.htm"></c:url>
                <div class="col-md-6"><a href="${tambahData}"><button class="btn btn-primary">TAMBAH</button></a></div>

                <form method="post" action="cariUser.htm">
                <div class="col-md-2">
                    <select class="form-control" id="drop" name="cariBerdasarkan">
                        <option value="1">Kode User</option>
                        <option value="2">Username</option>
                        <option value="3">NIM/NIP</option>
                        <option value="4">Akademik</option>
                        <option value="5">Dekan</option>
                        <option value="6">Kajur</option>
                        <option value="7">Dosen</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-blue">
                            <div class="panel-heading dark-overlay">Tabel Data User</div>
                            <div class="panel-body">
                                ...
                                <table border="4">
                                    ...
                                    <c:forEach var="listUser" items="${listDto}">
                                        <tr>  
                                            <td align="center" class="col-md-2 control-label">${listUser.kduser}</td>
                                            <td align="center" class="col-md-2 control-label">${listUser.username}</td>
                                            <td align="center" class="col-md-2 control-label">${listUser.password}</td>
                                            <td align="center" class="col-md-2 control-label">${listUser.akses}</td>
                                            <td align="center" class="col-md-2 control-label">${listUser.nim}</td>
                                            <td align="center" class="col-md-2 control-label">${listUser.nip}</td>
                                            <td align="center" class="col-md-2 control-label">${listUser.keterangan}</td>

                                            <c:url var="hapusList" value="/hapusListUser.htm">
                                                <c:param name="kduser" value="${listUser.kduser}"/>
                                            </c:url>
                                            <c:url var="editList" value="/editUser.htm">
                                                <c:param name="kduser" value="${listUser.kduser}"/>
                                            </c:url>
