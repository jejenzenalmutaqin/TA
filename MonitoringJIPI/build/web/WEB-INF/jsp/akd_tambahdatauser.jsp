                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Form Tambah Data User</div>
                            <div class="panel-body">
                                <form:form class="form-horizontal" id="formTambahUser" action="simpanDataUser.htm" method="post" modelAttribute="dto">
                                    <fieldset>
                                        <!-- Kode input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Kode User</label>
                                            <div class="col-md-9">
                                                <form:input path="kduser" placeholder="Kode User" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Username</label>
                                            <div class="col-md-9">
                                                <form:input path="username" placeholder="Username" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Password</label>
                                            <div class="col-md-9">
                                                <form:input path="password" placeholder="Password" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <form:select path="akses" class="form-control validate validate[required]">
                                                    <form:option value="" selected="true" disabled="true">Pilih Akses</form:option>
                                                    <c:forEach var="aks" items="${listAkses}">
                                                        <form:option value="${aks.kdakses}">${aks.namaakses}</form:option>
                                                        <c:set var="isiAkses" value="${aks.kdakses}"/>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >NIM / NIP</label>
                                            <div class="col-md-9">
                                                <form:input path="nim" placeholder="NIM / NIP" id="txnim" class="form-control" />
                                            </div>
                                        </div>
<!--                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >NIP</label>
                                            <div class="col-md-9">
                                                <form:input path="nip" placeholder="NIP"  class="form-control" />
                                            </div>
                                        </div>-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Keterangan</label>
                                            <div class="col-md-9">
                                                <form:input path="keterangan" placeholder="Keterangan"  class="form-control"/>
                                            </div>
                                        </div>
