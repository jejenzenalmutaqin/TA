...
<!--        begin-content-->
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            <div class="form-group">
                <c:url var="tambahData" value="/tambahSidang.htm"></c:url>
                            ...
                            <div class="panel-body">
                                ...
                                <table border="4">
                                    ...
                                    <c:forEach var="listSdg" items="${listDto}">
                                        <tr>  
                                            <td align="center" class="col-md-2 control-label">${listSdg.kdjenissidang}</td>
                                            <td align="center" class="col-md-2 control-label">${listSdg.nim}</td>
                                            <td align="center" class="col-md-2 control-label">${listSdg.kdproposal}</td>
                                            <td align="center" class="col-md-2 control-label">${listSdg.tglsidang}</td>
                                            <c:url var="hapusList" value="/hapusListSidang.htm">
                                                <c:param name="kdsidang" value="${listSdg.kdsidang}"/>
                                            </c:url>
                                            <c:url var="editList" value="/editSidang.htm">
                                                <c:param name="kdsidang" value="${listSdg.kdsidang}"/>
                                            </c:url>
                                            <c:url var="detailList" value="/detailSidang.htm">
                                                <c:param name="kdsidang" value="${listSdg.kdsidang}"/>
                                            </c:url>
                                            <c:url var="share" value="/shareSidang.htm">
                                                <c:param name="kdsidang" value="${listSdg.kdsidang}"/>
                                            </c:url>
