    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Laporan Pengajuan Sidang</li>
            </ol>
        </div><!--/.row-->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Filter Laporan Pengajuan Sidang</h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"> Form Filter Laporan Pengajuan Sidang</div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="filterProposal" action="laporansidang.htm" method="get">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" >Pilih Urutkan</label>
                                        <div class="col-md-9">
                                            <select name="urut_filter" class="form-control validate validate[required]">
                                                <option value="tglpengajuansidang">Tanggal Pengajuan Sidang</option>
                                                <option value="tglsidang" >Tanggal Sidang</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
