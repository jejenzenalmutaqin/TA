            ...
            <div class="navbar-header">
                ...
                <ul class="user-menu">
                    <li class="dropdown pull-right">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Home <span class="caret"></span></a>
...
<!--        <div class="row">
        ...
        <center>
            <div class="row">
                <div class="col-lg-12">
                    <img src="img/walpaper_png1.png" width="1150px" height="620px"/>
                </div>
            </div><!--/.row-->
        </center>
