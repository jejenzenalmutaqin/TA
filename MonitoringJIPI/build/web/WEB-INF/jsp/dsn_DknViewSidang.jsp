...
<!--//////////////////////////////// menu bar samping kiri //////////////////////////////	-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">          
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Pencarian Proposal</h1>
                </div>
            </div><!--/.row-->
		...
		<div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Filter View Proposal</div>
                            <div class="panel-body">
                        <form:form action="viewSidang.htm" modelAttribute="dto"  method="POST">    
                        <fieldset>
                                        ...
                                        <form:select path="kdjurusan" class="form-control validate validate[required]">
                                            <form:option value="" selected="true" disabled="true">Jurusan</form:option>
                                                <c:forEach var="prodi" items="${listJurusanDto}">
                                                    <form:option value="${prodi.kdjenispengajuan}">${prodi.namajenispengajuan}</form:option>
                                                </c:forEach>
                                        </form:select>
                                    </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" >Jenis Proposal </label>
                                    <div class="col-md-4">
                                            <form:radiobutton path="kdjenispengajuan" value="1"/>TA
                                    </div>
                                    <div class="col-md-4">
                                            <form:radiobutton path="kdjenispengajuan" value="2"/>Skripsi
                                    </div>
                                    <div class="col-md-4">
                                            <form:radiobutton path="kdjenispengajuan" value="3"/>UP
                                    </div>
                                    <div class="col-md-4">
                                            <form:radiobutton path="kdjenispengajuan" value="4"/>Seluruh
                                   </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <form:hidden path="judulproposal"/>
                                <form:hidden path="namajenispengajuan"/>
                                <form:hidden path="kdsidang"/>
                                <form:hidden path="kdjenissidang"/>
                                <form:hidden path="kdproposal"/>
                                
                                <form:hidden path="tglpengajuansidang"/>
                                <form:hidden path="penelaah1"/>
                                <form:hidden path="penelaah2"/>
                                <form:hidden path="wakilfakultas"/>
                                <form:hidden path="tglsidang"/>
                                <form:hidden path="ruangansidang"/>
                                <form:hidden path="namajurusan"/>
