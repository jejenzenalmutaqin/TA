                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Form Tambah Data Alumni</div>
                            <div class="panel-body">
                                <form:form class="form-horizontal" id="formTambahAlumni" action="simpanDataAlumni.htm" method="post" modelAttribute="dto">
                                    <fieldset>
                                        <!-- Kode input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Kode Alumni</label>
                                            <div class="col-md-9">
                                                <form:input path="kdalumni" placeholder="Kode Alumni" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <form:input path="kdkelulusan" placeholder="Kode Kelulusan" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Mulai Bekerja</label>
                                            <div class="col-md-9">
                                                <form:input path="tglmulaikerja" id="tg_mulaikerja" placeholder="Tanggal Mulai Kerja" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Perusahaan</label>
                                            <div class="col-md-9">
                                                <form:input path="perusahaan" placeholder="Nama Perusahaan" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Email Perusahaan</label>
                                            <div class="col-md-9">
                                                <form:input path="emailperusahaan" placeholder="Email Perusahaan" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Alamat Perusahaan</label>
                                            <div class="col-md-9">
                                                <form:input path="alamatperusahaan" placeholder="Alamat Lengkap Perusahaan" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Daerah Kerja</label>
                                            <div class="col-md-9">
                                                    <form:input path="daerahkerja" placeholder="Kota" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <form:input path="profesi" id="Profesi" placeholder="Profesi" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Testimoni</label>
                                            <div class="col-md-9">
                                                <form:input path="testimoni" placeholder="Testimoni" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Photo</label>
                                            <div class="col-md-9">
                                                <form:input path="foto" placeholder="Foto .jpg" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
