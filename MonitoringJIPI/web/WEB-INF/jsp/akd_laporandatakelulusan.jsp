    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Laporan Data Kelulusan</li>
            </ol>
        </div><!--/.row-->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Filter Laporan Data Kelulusan</h1>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"> Form Filter Laporan Data Kelulusan</div>
                        <div class="panel-body">
                            <form class="form-horizontal" id="filterProposal" action="laporankelulusan.htm" method="get">
                                <fieldset>
