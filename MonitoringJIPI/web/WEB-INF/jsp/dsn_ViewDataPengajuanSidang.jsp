                            ...
                            <div class="panel-body">
                                ...
                                <table border="4">
                                    <tr>
                                        ...
                                        <th class="col-md-2 control-label">Jurusan</th>
                                        <th class="col-md-2 control-label">Tanggal Pengajuan</th>
                                        <th class="col-md-2 control-label">Penelaah 1</th>
                                        <th class="col-md-2 control-label">Penelaah 2</th>
                                        <th class="col-md-2 control-label">Wakil Fakultas</th>
                                        <th class="col-md-2 control-label">Tgl Sidang</th>
                                        <th class="col-md-2 control-label">Ruangan Sidang</th>
                                        <th class="col-md-2 control-label">Jam Sidang</th>
                                    </tr>
                                    ...
                                    <c:forEach var="listProp" items="${listDto}">
                                        <tr>  
                                            ...
                                            <td align="center" class="col-md-2 control-label">${listProp.namajenispengajuan}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.namajurusan}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.tglpengajuansidang}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.penelaah1}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.penelaah2}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.wakilfakultas}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.tglsidang}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.ruangansidang}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.jamsidang}</td>
                                          </tr>            
                                    </c:forEach>
                                </table>
                            </div>
