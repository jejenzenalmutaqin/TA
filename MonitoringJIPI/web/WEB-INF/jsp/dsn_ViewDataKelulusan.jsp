                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-blue">
                            <div class="panel-heading dark-overlay">Data Kelulusan</div>
                            <div class="panel-body">
                                ...
                                <table border="4">
                                    <tr>
                                        ...
                                        <th class="col-md-2 control-label">Revisi</th>
                                        <th class="col-md-2 control-label">Tgl Mulai Revisi</th>
                                        <th class="col-md-2 control-label">Tgl Akhir Revisi</th>
                                        <th class="col-md-2 control-label">Tgl Penyerahan Revisi</th>
                                    </tr>
                                    ...
                                    <c:forEach var="listProp" items="${listDto}">
                                        <tr>  
                                            ...
                                            <td align="center" class="col-md-2 control-label">${listProp.revisi}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.mulairevisi}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.akhirrevisi}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.penyerahanrevisi}</td>
                                          </tr>            
                                    </c:forEach>
                                </table>
                            </div>
