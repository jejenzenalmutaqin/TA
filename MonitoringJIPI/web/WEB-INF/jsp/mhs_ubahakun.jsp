                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form:form class="form-horizontal" id="formEditUser" action="editDataBaru.htm" method="GET" modelAttribute="userDto">

                                <form:hidden path="kduser" value="${userDto.kduser}"/>
                                <form:hidden path="nim" value="${userDto.nim}"/>
                                <form:hidden path="akses" value="${userDto.akses}"/>
                                <form:hidden path="keterangan" value="${userDto.keterangan}"/>
                                <form:hidden path="nip" value="${userDto.nip}"/>
                                <!-- Kode input-->
                                <fieldset>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" >Username</label>
                                        <div class="col-md-9">
                                            <form:input path="username" value="${userDto.username}" class="form-control validate validate[required]"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" >Password Lama</label>
                                        <div class="col-md-9">
                                            <form:input path="password" type="password" value="${userDto.password}" class="form-control validate validate[required]"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" >Password Baru</label>
                                        <c:set var="passbaru" value=""></c:set>
                                        <c:set var="passconfirm" value=""></c:set>
                                            <div class="col-md-9">
                                            <form:input path="nip" type="password" value="${passbaru}" class="form-control validate validate[required]"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" >Konfirmasi Password</label>
                                        <div class="col-md-9">
                                            <form:input path="nip" type="password" value="${passconfirm}" class="form-control validate validate[required]"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
