                                ...
                                <form:form class="form-horizontal" id="formEditKelulusan" action="editDataKelulusan.htm" method="post" modelAttribute="dto">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <form:input path="kdsidang" value="${dto.kdsidang}" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Tanggal Lulus</label>
                                            <div class="col-md-9">
                                                <form:input path="tgllulus" id="tg_ls" value="${dto.tgllulus}" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                    <form:radiobutton path="revisi" value="${dto.revisi}" class="form-control"/>Ya
                                            </div>
                                            <div class="col-md-1">
                                                    <form:radiobutton path="revisi" value="${dto.revisi}" class="form-control"/>Tidak
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Mulai Revisi</label>
                                            <div class="col-md-9">
                                                <form:input path="mulairevisi" id="tg_awal" value="${dto.mulairevisi}" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Akhir Revisi</label>
                                            <div class="col-md-9">
                                                <form:input path="akhirrevisi" id="tg_last" value="${dto.akhirrevisi}" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Penyerahan Revisi</label>
                                            <div class="col-md-9">
                                                <form:input path="penyerahanrevisi" id="tg_serah" value="${dto.penyerahanrevisi}" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
