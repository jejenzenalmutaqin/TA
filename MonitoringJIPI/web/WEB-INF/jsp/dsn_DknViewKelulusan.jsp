...
<!--//////////////////////////////// menu bar samping kiri //////////////////////////////	-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">          
            <div class="row">
                <ol class="breadcrumb">
                    <li><a href="dsn_index.htm"><svg class="glyph stroked home"><use xlink:href="#stroked-home"></use></svg></a></li>
		...
		<div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Filter Data kelulusan</div>
                            <div class="panel-body">
                        <form:form action="viewKelulusan.htm" modelAttribute="dto"  method="POST">    
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <form:hidden path="tgllulus"/>
                                <form:hidden path="revisi"/>
                                <form:hidden path="mulairevisi"/>
                                <form:hidden path="akhirrevisi"/>
                                <form:hidden path="penyerahanrevisi"/>
                        </form:form>
                    </div>
		</div><!--/.row-->
                </center>
