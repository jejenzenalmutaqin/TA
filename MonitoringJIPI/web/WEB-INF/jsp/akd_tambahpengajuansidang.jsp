                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Form Tambah Data Pengajuan Sidang</div>
                            <div class="panel-body">
                                <form:form class="form-horizontal" id="formTambahSidang" action="simpanDataPengajuanSidang.htm" method="post" modelAttribute="dto">
                                    <fieldset>
                                        <!-- Kode input-->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Kode Sidang</label>
                                            <div class="col-md-9">
                                                <form:input path="kdsidang" placeholder="Kode Sidang" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
<!--                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <form:select path="kdjenissidang" class="form-control validate validate[required]">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <form:input path="kdproposal" placeholder="Kode Proposal" class="form-control"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <form:input path="tglpengajuansidang" id="tg_pg" placeholder="Tanggal Pengajuan" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Penelaah 1</label>
                                            <div class="col-md-9">
                                                <form:input path="penelaah1" placeholder="Penelaah 1" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Penelaah 2</label>
                                            <div class="col-md-9">
                                                <form:input path="penelaah2" placeholder="Penelaah 2" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Wakil Fakultas</label>
                                            <div class="col-md-9">
                                                <form:input path="wakilfakultas" placeholder="Wakil Fakultas" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Jam Sidang</label>
                                            <div class="col-md-9">
                                                <form:input path="jamsidang" placeholder="" value="08:00" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Tanggal Sidang</label>
                                            <div class="col-md-9">
                                                <form:input path="tglsidang" id="tg_sg" placeholder="Tanggal Sidang" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Ruangan Sidang</label>
                                            <div class="col-md-9">
                                                <form:input path="ruangansidang" placeholder="Ruangan Sidang" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
