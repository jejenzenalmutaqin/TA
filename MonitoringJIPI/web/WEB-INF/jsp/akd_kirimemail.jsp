    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="akd_kirimemail.htm"><svg class="glyph stroked email"><use xlink:href="#stroked-email"></use></svg> Kirim Email</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" id="formNotif" action="sendEmailFromDashboard.htm" method="post">
                                    <fieldset>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Kepada</label>
                                            <div class="col-md-9">
                                                <input type="text" name="recipient" placeholder="Masukan alamat email" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Subject</label>
                                            <div class="col-md-9">
                                                <input type="text" name="subject" placeholder="Masukan subject email" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea textarea cols="50" rows="10" name="message"  class="form-control">
