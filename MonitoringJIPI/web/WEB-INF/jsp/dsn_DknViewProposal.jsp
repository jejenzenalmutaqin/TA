	 ...
	 <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">          
		...
		<div class="row">
                    <div class="col-md-12">
                        ...
                        <form:form action="viewProposal.htm" modelAttribute="dto"  method="POST">    
                        <fieldset>
                                        <!-- Kode input-->
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" >Pilih Berdasarkan </label>
                                    <div class="col-md-9">
                                        <form:select path="jurusan" class="form-control validate validate[required]">
                            ...
                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <form:radiobutton path="jenisPengajuan" value="1"/>TA
                                        </div>
                                        <div class="col-md-4">
                                            <form:radiobutton path="jenisPengajuan" value="2"/>Skripsi
                                        </div>
                                        <div class="col-md-4">
                                            <form:radiobutton path="jenisPengajuan" value="3"/>UP
                                        </div>
                                        <div class="col-md-4">
                                           <form:radiobutton path="jenisPengajuan" value="4"/>Seluruh
                                        </div>
                                    </div><br/>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <form:hidden path="judul"/>
                                <form:hidden path="perubahanJudul"/>
                                <form:hidden path="sks"/>
                                <form:hidden path="tglPengajuan"/>
                                <form:hidden path="pembimbing"/>
