                            ...
                            <div class="panel-body">
                                ...
                                <table border="4">
                                    <tr>
                                        ...
                                        <th class="col-md-2 control-label">Jumlah SKS</th>
                                    ...
                                    <c:forEach var="listProp" items="${listDto}">
                                        <tr>  
                                            ...
                                            <td align="center" class="col-md-2 control-label">${listProp.nama}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.judul}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.perubahanJudul}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.tglPengajuan}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.pembimbing}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.sks}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.jurusan}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.fakultas}</td>
                                            <td align="center" class="col-md-2 control-label">${listProp.sks}</td>
