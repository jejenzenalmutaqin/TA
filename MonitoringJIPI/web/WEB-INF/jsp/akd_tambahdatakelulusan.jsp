                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Form Tambah Data Kelulusan</div>
                                ...
                                <form:form class="form-horizontal" id="formTambahKelulusan" action="simpanDataKelulusan.htm" method="post" modelAttribute="dto">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <form:input path="kdsidang" placeholder="Kode Sidang" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Tanggal Lulus</label>
                                            <div class="col-md-9">
                                                <form:input path="tgllulus" id="tg_ls" placeholder="Tanggal Lulus" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >IPK</label>
                                            <div class="col-md-9">
                                                <form:input path="ipk" placeholder="IPK Akhir" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Mulai Revisi</label>
                                            <div class="col-md-9">
                                                <form:input path="mulairevisi" id="tg_awal" placeholder="Mulai Revisi" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Akhir Revisi</label>
                                            <div class="col-md-9">
                                                <form:input path="akhirrevisi" id="tg_akhir" placeholder="Akhir Revisi" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Penyerahan Revisi</label>
                                            <div class="col-md-9">
                                                <form:input path="penyerahanrevisi" id="tg_serah" placeholder="Penyerahan Revisi" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
