    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="active"><a href="akd_buatnotifikasi.htm"><svg class="glyph stroked empty message"><use xlink:href="#stroked-empty-message"></use></svg> Notifikasi</a></li>
                <li class="parent ">
                    <a href="#">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Buat Notifikasi</h1>
                </div>
            </div><!--/.row-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Form Notifikasi</div>
                            <div class="panel-body">
                                <form class="form-horizontal" id="formNotif" action="simpanNotifikasi.htm" method="get">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="nim" id="txNim" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Subject Notifikasi</label>
                                            <div class="col-md-9">
                                                <select class="form-control" id="drop" name="subjeknotif" class="form-control validate validate[required]">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Judul Notifikasi</label>
                                            <div class="col-md-9">
                                                <input type="text" name="judulnotif" class="form-control validate validate[required]"/>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-3 control-label" >Isi Notifikasi</label>
                                            <div class="col-md-9">
                                                <textarea cols="50" rows="10" name="isinotif" class="form-control"></textarea>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-md-12 widget-right">
                                                <input type="submit" class="btn btn-primary btn-md pull-right"  id="sbm" value="Kirim" />
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
...
//                $(function()
//                {
//                    var txCari = $('#txCari').val();
//                    $.ajax({
//                        type: 'POST',
//                        url: "cariMahasiswa.htm",
//                        data: "nim=" + txCari,
//                        success: function (response) {
//                            alert(response);
           ...
           $(document).ready(function(){
            $("#txCari").change(function () {
                ...
                $.ajax({
                    ...
                    error: function (e) {
                        alert('Tidak ada yang cocok dengan yang di cari. Masukan kata kunci lebih spesifik');
                    }
                });
            });
        });
