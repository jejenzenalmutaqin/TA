                        ...
                        <div class="panel panel-blue">
                            ...
                            <div class="panel-body">
                                ...
                                <table style="color: white"  border="4">
                                    <tr>
                                        <th style="text-align: center" class="col-md-2 control-label">Kode Kelulusan</th>
                                        <th style="text-align: center"  class="col-md-2 control-label">Nama</th>
                                        <th style="text-align: center"  class="col-md-2 control-label">Tanggal Lulus</th>
                                        <th style="text-align: center"  class="col-md-2 control-label">Mulai Revisi</th>
                                        <th style="text-align: center"  class="col-md-2 control-label">Akhir Revisi</th>
                                        <th style="text-align: center"  class="col-md-2 control-label">Penyerahan Revisi</th>
                                    ...
                                    <c:forEach var="listKel" items="${listDto}">
                                        <tr>  
                                            ...
                                            <td align="center"><a href="${shareList}"><label style="color: yellow"  class="col-md-3 control-label">Bagikan</label></a></td>
                                        </tr>            
